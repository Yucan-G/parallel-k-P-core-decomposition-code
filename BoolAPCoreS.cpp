...
void BoolAPCoreS()
{
	...
	timeval time_over;
	timeval time1, time2;
	cout << "Ready to run BoolAPCore(S)..." << endl;
	...
	cout << "running time of BoolAPcore(S):" << run_time / 1000 << "ms\n\n";
	BoolAPCoreS_runtime = run_time;
}
